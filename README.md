...
class Développeur:
    ...
    def __init__(self):
        self.name = "Cyril Leconte"
        self.role = "Développeur IA"
        self.language_spoken = ["fr_FR", "en_US"]

    def say_hi(self):
        print("Any feedback, is great feedback")
...
- LinkedIn: [linkedin.com/in/cyril-leconte/](https://www.linkedin.com/in/cyril-leconte/)
- Kaggle: [kaggle.com/cyrilleconte](https://www.kaggle.com/cyrilleconte)
